...
import com.example.model.GraphMatrix;
import com.example.model.MatrizGenerica;
...
public class AppTest {
    ...
    @Test
    public void addMultipleVerticesTest() {
        setUp();
        boolean result = graph.addVertex(1);
        boolean result2 = graph.addVertex(2);
        boolean result3 = graph.addVertex(3);
        boolean result4 = graph.addVertex(4);
        assertTrue(result);
        assertTrue(result2);
        assertTrue(result3);
        assertTrue(result4);

        assertEquals(4, graph.getVertexList().size());
    }
    ...
    @Test
    public void addVertexDuplicateTestMatrix() {
        setUp2();
    ...
    @Test
    public void addMultipleVerticesTestMatrix() {
        setUp2();
        boolean result = graphM.addVertex(1);
        boolean result2 = graphM.addVertex(2);
        boolean result3 = graphM.addVertex(3);
        boolean result4 = graphM.addVertex(4);
        assertTrue(result);
        assertTrue(result2);
        assertTrue(result3);
        assertTrue(result4);

        assertEquals(4, graphM.getVertexList().size());
    }
    ...
    @Test
    public void addVertexDirectDuplicateTest() {
        setUp();
        graph.addVertex(1);
        graph.addVertex(2);
    ...
    @Test
    public void addVertexDirectOrderTest() {
        setUp();
        graph.addVertex(1);
        graph.addVertex(2);
        graph.addVertex(3);
    ...
    @Test
    public void addVertexDirectMatrixDuplicateTest() {
        setUp2();
        graphM.addVertex(1);
        graphM.addVertex(2);
    ...
    @Test
    public void addVertexDirectMatrixOrderTest() {
        setUp2();
        graphM.addVertex(1);
        graphM.addVertex(2);
        graphM.addVertex(3);
    ...
    @Test
    public void floydWarshallNegativeCycleTest() {
        setUp();
        Graph<String> graphS = new Graph<>(false);
        ...
        graphS.addVertex("C");
        graphS.addEdge("A", "B", 1, "");
        graphS.addEdge("B", "C", -3, "");

        Pair<int[][], MatrizGenerica<Vertex<String>, Vertex<String>>> res = graphS.floyWarshall();
        int[][] distances = res.getValue1();
    ...
    public void primTest2() {
        ...
        Vertex<String> sf = new Vertex<>("SF");
        Vertex<String> de = new Vertex<>("DE");
        Vertex<String> ch = new Vertex<>("CH");
        Vertex<String> ny = new Vertex<>("NY");
        Vertex<String> at = new Vertex<>("AT");
        ...
        graphS.addEdge("SF", "CH", 1200, "SF-CH");
        graphS.addEdge("DE", "CH", 1300, "DE-CH");
        graphS.addEdge("DE", "AT", 1400, "DE-AT");
        graphS.addEdge("DE", "NY", 1600, "DE-NY");
        graphS.addEdge("SF", "DE", 900, "SF-DE");
        graphS.addEdge("SF", "AT", 2200, "SF-AT");
        graphS.addEdge("SF", "NY", 2000, "SF-NY");
        graphS.addEdge("CH", "AT", 700, "CH-AT");
        graphS.addEdge("CH", "NY", 1000, "CH-NY");
        graphS.addEdge("NY", "AT", 800, "NY-AT");

        graphS.Prim();

        for (Vertex<String> vertex : graphS.getVertexList().values()) {
            Vertex<String> parent = vertex.getParent();
            if (parent != null) {
                assertTrue(graphS.edgeExists(parent.getValue(), vertex.getValue()));
            }
        }
        ...
        for (Vertex<String> vertex : graphS.getVertexList().values()) {
            Vertex<String> parent = vertex.getParent();
            if (parent != null) {
                totalWeight += vertex.getWeight(parent);
            }
        }
        assertEquals(3600, totalWeight);
    }
    ...
    @Test
    public void kruskalEmptyGraphTest() {
        setUp();
        Graph<String> graphS = new Graph<>(false);
    ...
    @Test
    public void kruskalSingleVertexTest() {
        setUp();
        Graph<String> graphS = new Graph<>(false);
